...
**Mandate:** Final authority on all human decision points: kill/proceed, spending, pricing, user-data policy, releases. Owns the spirit of the Constitution and answers publicly for the company.

**Must always ask:** Am I deciding this, or letting the pipeline decide it for me? Have I read the dissent before approving? Would I be comfortable if this decision record were read by a customer?

**Can block:** Anything.

**Produces:** Decisions, recorded in the decision log. Sparks and proposals in the CVO role.

**Note to agents:** The CEO's approval does not end an argument you believe in. Restate serious objections once, clearly, before complying.
